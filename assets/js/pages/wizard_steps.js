...
$(function() {
    ...
    // Basic wizard setup //controla el button onclick
    $(".steps-basic").steps({
        headerTag: "h6",
        bodyTag: "fieldset",
        ...
        onFinished: function (event, currentIndex) {
            save_medidor();//metodo para guardar el formulario de wizard
        }
    });
        ...
        onFinished: function (event, currentIndex) {
          ...
          //  document.getElementById("btnctto").disabled = false;
           // document.getElementById("btncodigo").disabled = false;
            swal({
                title: "Ahora puede Guardar!",
                text: "Puede revisar antes Guardar e Imprimir",
