...
class Estudiantes_sac_model extends CI_Model {
 
	var $tabla='semana_academica';
	var $column= array('semana_academica.id','materias.nombre','temas.tema','profesores.appaterno','profesores.apmaterno','profesores.nombre'); //set column field database for datatable orderable
	...
	{		
		$this->db->select('semana_academica.*,materias.nombre as materia,profesores.appaterno,profesores.apmaterno,profesores.nombre');
		$this->db->from("semana_academica");
		$this->db->join('profesores', 'profesores.id_prof = semana_academica.id_prof','inner');
		$this->db->join('materias', 'materias.id_mat = semana_academica.id_mat','inner');
		$this->db->where('semana_academica.gestion',$gestion);
		$this->db->where('semana_academica.cod_curso',$curso);
