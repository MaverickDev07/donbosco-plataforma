...
class Rep_centralizador_model extends CI_Model {
	...
	public function get_materias()
	{
		...
		$this->db->where("id_mat",1);
		$this->db->or_where("id_mat",3);
		$this->db->or_where("id_mat",5);
		$this->db->or_where("id_mat",9);
		$this->db->or_where("id_mat",10);
		$this->db->or_where("id_mat",11);
		$this->db->or_where("id_mat",12);
		$this->db->or_where("id_mat",13);
		$this->db->or_where("id_mat",20);
		$this->db->or_where("id_mat",25);
		*/
		/*
		SECUNDARIA 1 A 2
		$this->db->from("materias");	
		$this->db->where("id_mat",1);
		$this->db->or_where("id_mat",4);
		$this->db->or_where("id_mat",5);
		$this->db->or_where("id_mat",9);
		$this->db->or_where("id_mat",10);
		$this->db->or_where("id_mat",11);
		$this->db->or_where("id_mat",12);
		$this->db->or_where("id_mat",14);
		$this->db->or_where("id_mat",15);
		$this->db->or_where("id_mat",16);
		$this->db->or_where("id_mat",21);
		$this->db->or_where("id_mat",24);
		$this->db->or_where("id_mat",25); 
		*/
		/*
		secundaria 3A
		...
		$this->db->or_where("id_mat",11);
		$this->db->or_where("id_mat",12);
		$this->db->or_where("id_mat",18);
		$this->db->or_where("id_mat",19);
		$this->db->or_where("id_mat",21);
		$this->db->or_where("id_mat",22);
		$this->db->or_where("id_mat",23);
		$this->db->or_where("id_mat",24);
		$this->db->or_where("id_mat",25);
		*/
		/*
		...
		$this->db->from("materias");	
		$this->db->where("id_mat",1);
		$this->db->or_where("id_mat",1);
		$this->db->or_where("id_mat",4);
		$this->db->or_where("id_mat",5);
		$this->db->or_where("id_mat",6);
		$this->db->or_where("id_mat",7);
		$this->db->or_where("id_mat",8);
		$this->db->or_where("id_mat",9);
		$this->db->or_where("id_mat",10);
		$this->db->or_where("id_mat",11);
		$this->db->or_where("id_mat",12);
	...
	public function get_bimestres()
	{
		...
		$this->db->where("id_bi",6);
		$this->db->or_where("id_bi",7);
		$query = $this->db->get();

		return $query->result();
	}

	public function get_estudiantes($codigo)
	{
		$this->db->from("nota_prom");		
		$this->db->where("gestion",2020);
		//$this->db->where("id_est",432);
		//$this->db->or_where('codigo' ,'6A-SM-3');
		//$this->db->or_where('codigo' ,'6B-SM-3');
		//$this->db->or_where('codigo' ,'6C-SM-3');
		//$this->db->where('codigo !=' ,'1A-PT-1');
		//$this->db->where('codigo !=' ,'1B-PT-1');
		/*$this->db->where('codigo !=' ,'5A-PT-1');
		$this->db->where('codigo !=' ,'5B-PT-1');
		$this->db->where('codigo !=' ,'6A-PT-1');
		$this->db->where('codigo !=' ,'6B-PT-1');
		$this->db->where('codigo !=' ,'6C-PT-1');
		$this->db->where('codigo !=' ,'2A-PT-1');
		$this->db->where('codigo !=' ,'2B-PT-1');
		$this->db->where('codigo !=' ,'3A-PT-1');
		$this->db->where('codigo !=' ,'3B-PT-1');
		$this->db->where('codigo !=' ,'4A-PT-1');
		$this->db->where('codigo !=' ,'4B-PT-1');*/
		//$this->db->like('codigo', $codigo, 'both');
		//$this->db->like('codigo', '6A-ST-2', 'both');
		//$this->db->like('codigo', '6B-ST-2', 'both');
		$this->db->like('codigo', '6C-ST-2', 'both');
		//$this->db->like('codigo', '3A-ST-2', 'both');
		//$this->db->like('codigo', '3B-ST-2', 'both');
		//$this->db->like('codigo', '5C-ST-2', 'both');
	...
	public function nota_bimestre($final,$codigo,$id_mat,$gestion,$bi,$id_est)
	{	
		$ids=explode('-', $codigo, -1);
			$curso=$ids[0];
			$nivel=$ids[1];	
			$odigos=$curso."-".$nivel."-";
		$sql="UPDATE nota_bimestre SET final=".$final." WHERE codigo LIKE '".$curso."-".$nivel."-%-%-%-".$id_mat."-%-%' AND gestion = ".$gestion." AND id_bi = ".$bi." AND id_est = ".$id_est;
		//$sql="UPDATE nota_bimestre SET final=".$final." WHERE codigo LIKE '1B-SM-%-%-%-".$id_mat."-%-%' AND gestion = ".$gestion." AND id_bi = ".$bi." AND id_est = ".$id_est;
		$query  = $this->db->query($sql);		
		return 1;
	}

public function promedio_nota11($id_mat,$id_est)
	{		
		$this->db->select("notabi1 as final");	
	...
	public function promedio_nota1($id_mat,$id_est)
	{		
		$this->db->select("notabi2 as final");	
		$this->db->from("nota_materia");		
	...
	public function promedio_nota2($id_mat,$id_est)
	{		
		$this->db->select("notabi3 as final");	
		$this->db->from("nota_materia");		
		$this->db->where("gestion",2019);	
		$this->db->where("id_mat",$id_mat);		
		$this->db->where("id_est",$id_est);
	...
	public function nota_materias($id_mate,$id_est,$gestion)
	{
		$sql="SELECT *
			FROM nota_materia 
			WHERE id_mat=".$id_mate." and id_est=".$id_est." and gestion=".$gestion;
		$query  = $this->db->query($sql);
		return $query->row();
	}
	...
	public function get_mate($id_est,$mat1,$mat2,$mat3,$mat4,$mat5,$mat6,$mat7,$mat8,$mat9,$mat10,$mat11,$mat12,$mat13,$mat14,$bi,$gestion)
	{
		if($bi==5){
			$sql="SELECT estudiantes.id_est,
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.notabi1 ELSE 0 END) AS lenguaje,
			(CASE WHEN nota_materia.id_mat =".$mat2." THEN nota_materia.notabi1 ELSE 0 END) AS gramatica,
			(CASE WHEN nota_materia.id_mat =".$mat3." THEN nota_materia.notabi1 ELSE 0 END) AS ingles,
			(CASE WHEN nota_materia.id_mat =".$mat4." THEN nota_materia.notabi1 ELSE 0 END) AS sociales,
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.notabi1 ELSE 0 END) AS edfisica,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.notabi1 ELSE 0 END) AS edmusica,
		...
		if($bi==6){
			...
			(CASE WHEN nota_materia.id_mat =".$mat2." THEN nota_materia.notabi2 ELSE 0 END) AS gramatica,
		...
		if($bi==7){
			...
			(CASE WHEN nota_materia.id_mat =".$mat2." THEN nota_materia.notabi3 ELSE 0 END) AS gramatica,
	...
	public function get_matec($id_est,$mat1,$mat2,$mat3,$mat4,$mat5,$mat6,$mat7,$mat8,$mat9,$mat10,$mat11,$mat12,$mat13,$mat14,$bi,$gestion)
	{
		if($bi==5){
			$sql="SELECT estudiantes.id_est,
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.nota1 ELSE 0 END) AS lenguaje,
			(CASE WHEN nota_materia.id_mat =".$mat2." THEN nota_materia.nota1 ELSE 0 END) AS gramatica,
			(CASE WHEN nota_materia.id_mat =".$mat3." THEN nota_materia.nota1 ELSE 0 END) AS ingles,
			(CASE WHEN nota_materia.id_mat =".$mat4." THEN nota_materia.nota1 ELSE 0 END) AS sociales,
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.nota1 ELSE 0 END) AS edfisica,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.nota1 ELSE 0 END) AS edmusica,
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota1 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota1 ELSE 0 END) AS mate,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota1 ELSE 0 END) AS infromatica,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota1 ELSE 0 END) AS fisica,
			(CASE WHEN nota_materia.id_mat =".$mat11." THEN nota_materia.nota1 ELSE 0 END) AS  quimica,
			(CASE WHEN nota_materia.id_mat =".$mat12." THEN nota_materia.nota1 ELSE 0 END) AS naturales,
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota1 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota1 ELSE 0 END) AS religuion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		if($bi==6){
			$sql="SELECT estudiantes.id_est,
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.nota2 ELSE 0 END) AS lenguaje,
			(CASE WHEN nota_materia.id_mat =".$mat2." THEN nota_materia.nota2 ELSE 0 END) AS gramatica,
			(CASE WHEN nota_materia.id_mat =".$mat3." THEN nota_materia.nota2 ELSE 0 END) AS ingles,
			(CASE WHEN nota_materia.id_mat =".$mat4." THEN nota_materia.nota2 ELSE 0 END) AS sociales,
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.nota2 ELSE 0 END) AS edfisica,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.nota2 ELSE 0 END) AS edmusica,
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota2 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota2 ELSE 0 END) AS mate,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota2 ELSE 0 END) AS infromatica,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota2 ELSE 0 END) AS fisica,
			(CASE WHEN nota_materia.id_mat =".$mat11." THEN nota_materia.nota2 ELSE 0 END) AS  quimica,
			(CASE WHEN nota_materia.id_mat =".$mat12." THEN nota_materia.nota2 ELSE 0 END) AS naturales,
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota2 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota2 ELSE 0 END) AS religuion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		if($bi==7){
			$sql="SELECT estudiantes.id_est,
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.nota3 ELSE 0 END) AS lenguaje,
			(CASE WHEN nota_materia.id_mat =".$mat2." THEN nota_materia.nota3 ELSE 0 END) AS gramatica,
			(CASE WHEN nota_materia.id_mat =".$mat3." THEN nota_materia.nota3 ELSE 0 END) AS ingles,
			(CASE WHEN nota_materia.id_mat =".$mat4." THEN nota_materia.nota3 ELSE 0 END) AS sociales,
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.nota3 ELSE 0 END) AS edfisica,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.nota3 ELSE 0 END) AS edmusica,
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota3 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota3 ELSE 0 END) AS mate,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota3 ELSE 0 END) AS infromatica,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota3 ELSE 0 END) AS fisica,
			(CASE WHEN nota_materia.id_mat =".$mat11." THEN nota_materia.nota3 ELSE 0 END) AS  quimica,
			(CASE WHEN nota_materia.id_mat =".$mat12." THEN nota_materia.nota3 ELSE 0 END) AS naturales,
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota3 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota3 ELSE 0 END) AS religuion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		/*if($bi==4){
	...
	public function get_mate4c($id_est,$mat1,$mat2,$mat3,$mat4,$mat5,$mat6,$mat7,$mat8,$mat9,$mat10,$mat11,$mat12,$mat13,$mat14,$mat15,$bi,$gestion)
	//3Ros 
	{
		if($bi==5){
			$sql="SELECT estudiantes.id_est,
			...
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota1 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota1 ELSE 0 END) AS mate,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota1 ELSE 0 END) AS sistemas,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota1 ELSE 0 END) AS electronica,
			(CASE WHEN nota_materia.id_mat =".$mat11." THEN nota_materia.nota1 ELSE 0 END) AS naturales,
			(CASE WHEN nota_materia.id_mat =".$mat12." THEN nota_materia.nota1 ELSE 0 END) AS fisica,
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota1 ELSE 0 END) AS quimica,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota1 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat15." THEN nota_materia.nota1 ELSE 0 END) AS religuion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		if($bi==6){
			...
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota2 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota2 ELSE 0 END) AS mate,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota2 ELSE 0 END) AS sistemas,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota2 ELSE 0 END) AS electronica,
			(CASE WHEN nota_materia.id_mat =".$mat11." THEN nota_materia.nota2 ELSE 0 END) AS naturales,
			(CASE WHEN nota_materia.id_mat =".$mat12." THEN nota_materia.nota2 ELSE 0 END) AS fisica,
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota2 ELSE 0 END) AS quimica,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota2 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat15." THEN nota_materia.nota2 ELSE 0 END) AS religuion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		if($bi==7){
			...
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota3 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota3 ELSE 0 END) AS mate,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota3 ELSE 0 END) AS sistemas,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota3 ELSE 0 END) AS electronica,
			(CASE WHEN nota_materia.id_mat =".$mat11." THEN nota_materia.nota3 ELSE 0 END) AS naturales,
			(CASE WHEN nota_materia.id_mat =".$mat12." THEN nota_materia.nota3 ELSE 0 END) AS fisica,
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota3 ELSE 0 END) AS quimica,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota3 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat15." THEN nota_materia.nota3 ELSE 0 END) AS religuion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		/*if($bi==4){
	...
	public function get_mate6c($id_est,$mat1,$mat2,$mat3,$mat4,$mat5,$mat6,$mat7,$mat8,$mat9,$mat10,$mat11,$mat12,$mat13,$mat14,$bi,$gestion)
	{
		//4tos 
		if($bi==5){
			$sql="SELECT estudiantes.id_est,
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.nota1 ELSE 0 END) AS lenguaje,
			(CASE WHEN nota_materia.id_mat =".$mat2." THEN nota_materia.nota1 ELSE 0 END) AS ingles,
			(CASE WHEN nota_materia.id_mat =".$mat3." THEN nota_materia.nota1 ELSE 0 END) AS sociales,
			(CASE WHEN nota_materia.id_mat =".$mat4." THEN nota_materia.nota1 ELSE 0 END) AS edfisica,
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.nota1 ELSE 0 END) AS edmusica,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.nota1 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota1 ELSE 0 END) AS mate,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota1 ELSE 0 END) AS sistemas,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota1 ELSE 0 END) AS electronica,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota1 ELSE 0 END) AS naturales,
			(CASE WHEN nota_materia.id_mat =".$mat11." THEN nota_materia.nota1 ELSE 0 END) AS fisica,
			(CASE WHEN nota_materia.id_mat =".$mat12." THEN nota_materia.nota1 ELSE 0 END) AS  quimica,
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota1 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota1 ELSE 0 END) AS religuion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		...
		if($bi==6){
			$sql="SELECT estudiantes.id_est,
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.nota2 ELSE 0 END) AS lenguaje,
			(CASE WHEN nota_materia.id_mat =".$mat2." THEN nota_materia.nota2 ELSE 0 END) AS ingles,
			(CASE WHEN nota_materia.id_mat =".$mat3." THEN nota_materia.nota2 ELSE 0 END) AS sociales,
			(CASE WHEN nota_materia.id_mat =".$mat4." THEN nota_materia.nota2 ELSE 0 END) AS edfisica,
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.nota2 ELSE 0 END) AS edmusica,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.nota2 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota2 ELSE 0 END) AS mate,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota2 ELSE 0 END) AS sistemas,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota2 ELSE 0 END) AS electronica,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota2 ELSE 0 END) AS naturales,
			(CASE WHEN nota_materia.id_mat =".$mat11." THEN nota_materia.nota2 ELSE 0 END) AS fisica,
			(CASE WHEN nota_materia.id_mat =".$mat12." THEN nota_materia.nota2 ELSE 0 END) AS  quimica,
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota2 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota2 ELSE 0 END) AS religuion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		...
		if($bi==7){
			$sql="SELECT estudiantes.id_est,
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.nota3 ELSE 0 END) AS lenguaje,
			(CASE WHEN nota_materia.id_mat =".$mat2." THEN nota_materia.nota3 ELSE 0 END) AS ingles,
			(CASE WHEN nota_materia.id_mat =".$mat3." THEN nota_materia.nota3 ELSE 0 END) AS sociales,
			(CASE WHEN nota_materia.id_mat =".$mat4." THEN nota_materia.nota3 ELSE 0 END) AS edfisica,
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.nota3 ELSE 0 END) AS edmusica,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.nota3 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota3 ELSE 0 END) AS mate,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota3 ELSE 0 END) AS sistemas,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota3 ELSE 0 END) AS electronica,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota3 ELSE 0 END) AS naturales,
			(CASE WHEN nota_materia.id_mat =".$mat11." THEN nota_materia.nota3 ELSE 0 END) AS fisica,
			(CASE WHEN nota_materia.id_mat =".$mat12." THEN nota_materia.nota3 ELSE 0 END) AS  quimica,
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota3 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota3 ELSE 0 END) AS religuion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
	...
	public function get_mate1c($id_est,$mat1,$mat2,$mat3,$mat4,$mat5,$mat6,$mat7,$mat8,$mat9,$mat10,$mat11,$mat12,$mat13,$mat14,$bi,$gestion)
	{
		if($bi==5){
			$sql="SELECT estudiantes.id_est,
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.nota1 ELSE 0 END) AS lenguaje,
	...
	public function get_mate3c($id_est,$mat1,$mat2,$mat3,$mat4,$mat5,$mat6,$mat7,$mat8,$mat9,$mat10,$mat11,$mat12,$mat13,$mat14,$mat15,$bi,$gestion)
	{
		if($bi==5){
			$sql="SELECT estudiantes.id_est,
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.nota1 ELSE 0 END) AS lenguaje,
			...
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota1 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota1 ELSE 0 END) AS religuion,
			(CASE WHEN nota_materia.id_mat =".$mat15." THEN nota_materia.nota1 ELSE 0 END) AS estadisticas
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		if($bi==6){
			...
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota2 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota2 ELSE 0 END) AS religuion,
			(CASE WHEN nota_materia.id_mat =".$mat15." THEN nota_materia.nota2 ELSE 0 END) AS estadisticas
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		if($bi==7){
			...
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota3 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota3 ELSE 0 END) AS religuion,
			(CASE WHEN nota_materia.id_mat =".$mat15." THEN nota_materia.nota3 ELSE 0 END) AS estadisticas
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		/*if($bi==4){
	...
	public function get_mate2c($id_est,$mat1,$mat2,$mat3,$mat4,$mat5,$mat6,$mat7,$mat8,$mat9,$mat10,$mat11,$mat12,$mat13,$mat14,$mat15,$mat16,$bi,$gestion)
	{
		if($bi==5){
			$sql="SELECT estudiantes.id_est,
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.nota1 ELSE 0 END) AS lenguaje,
			(CASE WHEN nota_materia.id_mat =".$mat2." THEN nota_materia.nota1 ELSE 0 END) AS ingles,
			(CASE WHEN nota_materia.id_mat =".$mat3." THEN nota_materia.nota1 ELSE 0 END) AS historia,
			(CASE WHEN nota_materia.id_mat =".$mat4." THEN nota_materia.nota1 ELSE 0 END) AS civica,
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.nota1 ELSE 0 END) AS geografia,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.nota1 ELSE 0 END) AS edfisica,
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota1 ELSE 0 END) AS edmusica,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota1 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota1 ELSE 0 END) AS mate,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota1 ELSE 0 END) AS sistemas,
			(CASE WHEN nota_materia.id_mat =".$mat11." THEN nota_materia.nota1 ELSE 0 END) AS electronica,
			(CASE WHEN nota_materia.id_mat =".$mat12." THEN nota_materia.nota1 ELSE 0 END) AS naturales,
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota1 ELSE 0 END) AS  fisica,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota1 ELSE 0 END) AS quimica,
			(CASE WHEN nota_materia.id_mat =".$mat15." THEN nota_materia.nota1 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat16." THEN nota_materia.nota1 ELSE 0 END) AS religuion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		if($bi==6){
			...
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.nota2 ELSE 0 END) AS lenguaje,
			(CASE WHEN nota_materia.id_mat =".$mat2." THEN nota_materia.nota2 ELSE 0 END) AS ingles,
			(CASE WHEN nota_materia.id_mat =".$mat3." THEN nota_materia.nota2 ELSE 0 END) AS historia,
			(CASE WHEN nota_materia.id_mat =".$mat4." THEN nota_materia.nota2 ELSE 0 END) AS civica,
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.nota2 ELSE 0 END) AS geografia,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.nota2 ELSE 0 END) AS edfisica,
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota2 ELSE 0 END) AS edmusica,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota2 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota2 ELSE 0 END) AS mate,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota2 ELSE 0 END) AS sistemas,
			(CASE WHEN nota_materia.id_mat =".$mat11." THEN nota_materia.nota2 ELSE 0 END) AS electronica,
			(CASE WHEN nota_materia.id_mat =".$mat12." THEN nota_materia.nota2 ELSE 0 END) AS naturales,
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota2 ELSE 0 END) AS  fisica,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota2 ELSE 0 END) AS quimica,
			(CASE WHEN nota_materia.id_mat =".$mat15." THEN nota_materia.nota2 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat16." THEN nota_materia.nota2 ELSE 0 END) AS religuion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		if($bi==7){
			...
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.nota3 ELSE 0 END) AS lenguaje,
			(CASE WHEN nota_materia.id_mat =".$mat2." THEN nota_materia.nota3 ELSE 0 END) AS ingles,
			(CASE WHEN nota_materia.id_mat =".$mat3." THEN nota_materia.nota3 ELSE 0 END) AS historia,
			(CASE WHEN nota_materia.id_mat =".$mat4." THEN nota_materia.nota3 ELSE 0 END) AS civica,
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.nota3 ELSE 0 END) AS geografia,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.nota3 ELSE 0 END) AS edfisica,
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota3 ELSE 0 END) AS edmusica,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota3 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota3 ELSE 0 END) AS mate,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota3 ELSE 0 END) AS sistemas,
			(CASE WHEN nota_materia.id_mat =".$mat11." THEN nota_materia.nota3 ELSE 0 END) AS electronica,
			(CASE WHEN nota_materia.id_mat =".$mat12." THEN nota_materia.nota3 ELSE 0 END) AS naturales,
			(CASE WHEN nota_materia.id_mat =".$mat13." THEN nota_materia.nota3 ELSE 0 END) AS  fisica,
			(CASE WHEN nota_materia.id_mat =".$mat14." THEN nota_materia.nota3 ELSE 0 END) AS quimica,
			(CASE WHEN nota_materia.id_mat =".$mat15." THEN nota_materia.nota3 ELSE 0 END) AS filosofia,
			(CASE WHEN nota_materia.id_mat =".$mat16." THEN nota_materia.nota3 ELSE 0 END) AS religuion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		/*if($bi==4){
...
public function get_mate_primariac($id_est,$mat1,$mat2,$mat3,$mat4,$mat5,$mat6,$mat7,$mat8,$mat9,$mat10,$bi,$gestion)
	{
		if($bi==5){
			$sql="SELECT estudiantes.id_est,
			(CASE WHEN nota_materia.id_mat =".$mat1." THEN nota_materia.nota1 ELSE 0 END) AS lenguaje,
			...
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.nota1 ELSE 0 END) AS edmusica,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.nota1 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota1 ELSE 0 END) AS matematicas,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota1 ELSE 0 END) AS informatica,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota1 ELSE 0 END) AS maturales,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota1 ELSE 0 END) AS religion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		if($bi==6){
			...
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.nota2 ELSE 0 END) AS edmusica,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.nota2 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota2 ELSE 0 END) AS matematicas,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota2 ELSE 0 END) AS informatica,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota2 ELSE 0 END) AS maturales,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota2 ELSE 0 END) AS religion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		if($bi==7){
			...
			(CASE WHEN nota_materia.id_mat =".$mat5." THEN nota_materia.nota3 ELSE 0 END) AS edmusica,
			(CASE WHEN nota_materia.id_mat =".$mat6." THEN nota_materia.nota3 ELSE 0 END) AS artes,
			(CASE WHEN nota_materia.id_mat =".$mat7." THEN nota_materia.nota3 ELSE 0 END) AS matematicas,
			(CASE WHEN nota_materia.id_mat =".$mat8." THEN nota_materia.nota3 ELSE 0 END) AS informatica,
			(CASE WHEN nota_materia.id_mat =".$mat9." THEN nota_materia.nota3 ELSE 0 END) AS maturales,
			(CASE WHEN nota_materia.id_mat =".$mat10." THEN nota_materia.nota3 ELSE 0 END) AS religion
			from estudiantes  INNER JOIN nota_materia ON estudiantes.id_est=nota_materia.id_est
			where estudiantes.id_est=".$id_est." AND nota_materia.gestion=".$gestion;
		}
		/*if($bi==4){
	...
	public function kardex($id_est,$gestion,$bimestre)
	{
		$sql="SELECT reguistro_kardex.fecha,categoria.nombre as categoria,reguistro_kardex.descripcion 
FROM reguistro_kardex INNER JOIN estudiantes ON estudiantes.id_est=reguistro_kardex.id_est 
INNER JOIN categoria on categoria.id=reguistro_kardex.id_categoria
WHERE estudiantes.id_est='".$id_est."' AND reguistro_kardex.gestion=".$gestion." AND reguistro_kardex.id_bi<=".$bimestre." 
ORDER BY reguistro_kardex.fecha";
		$query  = $this->db->query($sql);
		return $query->result();
	}
