...
class Profesor_ca_model extends CI_Model {
 
	var $tabla='calendario'; 
	var $column= array('calendario.id','cursos.nombre','niveles.turno','niveles.nivel','temas.gestion','materias.nombre','calendario.nombre'); //set column field database for datatable orderable
	...
	var $order = array('calendario.cod_curso' => 'asc','calendario.id' => 'asc'); // default order 
	...
	{		
		$this->db->select('calendario.*,cursos.nombre as curso,niveles.turno,niveles.nivel,materias.nombre as materia');
		$this->db->from("calendario");
		$this->db->join('profesores', 'profesores.id_prof = calendario.id_prof','inner');
		$this->db->join('cursos', 'cursos.codigo = calendario.cod_curso','inner');
		$this->db->join('niveles', 'niveles.codigo = calendario.cod_nivel','inner');
