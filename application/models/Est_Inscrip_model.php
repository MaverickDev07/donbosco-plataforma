...
class Est_Inscrip_model extends CI_Model {
	...
	public function get_colegio($id,$gestion)
	{
	...
	public function buscar_tutor($id_padre,$id_est)
	{		
	...
	public function buscar_tutor1($tipo,$id_padre,$id_est)
	{		
		$this->db->from('reguistro_tutor');
	...
	public function get_data_estudiantes1($id,$gestion)
	{
		$this->db->select('estudiantes.*,nota_prom.codigo as codigos');
		$this->db->from('estudiantes');
		$this->db->where('estudiantes.id_est',$id);
	...
	public function get_data_factura($id_est,$gestion)
	{
	...
	public function deletes($tabla,$id)
	{
