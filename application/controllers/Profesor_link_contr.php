...
class Profesor_link_contr extends CI_Controller {
	...
	{
		parent::__construct();		
		$this->load->model('Profesor_link_model','mat');
	...
	public function vista()
	{
		...
		$this->load->view('Profesor_link_view');
	...
	{		
		...
		$nivel=$ids[1];
		$id_prof=$ids[2];
		$list=$this->mat->get_datatables_gestion($gestion,$nivel,$id_prof);	
		// print_r($list);
		// exit();
		$data = array();
		$no = $_POST['start'];
		...
		$output = array(
				"draw" => $_POST['draw'],
				"recordsTotal" => $this->mat->count_all(),
				"recordsFiltered" => $this->mat->count_filtered_gestion($gestion,$nivel,$id_prof),
				"data" => $data,
		);	
	...
	public function editar()
	{
		...
		$srcfile='/home/ARCHIVOS/ESTUDIANTES/'.$tarea;
		$dstfile='/opt/lampp/htdocs/donbosco/visualizar/'.$tarea;
		//print_r($dstfile);exit();
