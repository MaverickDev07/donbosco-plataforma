...
class Inscrip_contr extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('Inscrip_model', 'estud');
		$this->load->model('Karde_model', 'estudk');
	...
	public function ajax_save_estud()
	{
		...
		// $appat_est=$this->input->post('appaterno');
		// $apmat_est=$this->input->post('apmaterno');
		// $nombres_est=$this->input->post('nombres');
		// $list=$this->estud->get_estu($appat_est,$apmat_est,$nombres_est);
		// foreach($list as $listest)
		// {
		// 	$id_est=$listest->id_est;
		// }
		$id_est = $this->input->post('idestudiante');
		// $est=$this->estud->get_data_nota_prom1($id_est);
		// $ids=explode('-', $est->codigo."-", -1);
		// $curso=$ids[0];
		// $est1=$this->estud->get_idunidad1($this->input->post('idest1')); 
		// $curso=$this->input->post('curso');
		// if($est1!=null){
		// 	if($est1->repitente){
		// 	$curso=$ids[0]; 
	...
	public function print_rude($idins)
	{
		...
		if ($trabajo->actividad == 'Agricultura') $work15 = 'X';
		else $work15 = '';
		if ($trabajo->actividad == 'Ganadería o pesca') $work16 = 'X';
		else $work16 = '';
		if ($trabajo->actividad == 'Minería') $work17 = 'X';
		else $work17 = '';
		if ($trabajo->actividad == 'Construcción') $work18 = 'X';
		else $work18 = '';
		if ($trabajo->actividad == 'Vendedor dependiente') $work19 = 'X';
		else $work19 = '';
		if ($trabajo->actividad == 'Vendedor cuenta propia') $work20 = 'X';
		else $work20 = '';
		if ($trabajo->actividad == 'Transporte o mecánica') $work21 = 'X';
		else $work21 = '';
		if ($trabajo->actividad == 'Lustra Botas') $work22 = 'X';
		else $work22 = '';
		if ($trabajo->actividad == 'Trabajo del hogar o niñero') $work23 = 'X';
		else $work23 = '';
		if ($trabajo->actividad == 'Ayudante familiar') $work24 = 'X';
		else $work24 = '';
		if ($trabajo->actividad == 'Ayudante en el Hogar') $work25 = 'X';
		else $work25 = '';
		if ($trabajo->actividad == 'Otro trabajo') $work26 = 'X';
		else $work26 = '';
		...
		$this->pdf->Cell(4, 4, utf8_decode($work25), 'TBLR', 0, 'L', '0');
	...
	public function print_rude_curso_nivel_gestion($idins)
	{
		$ids = explode('-', $idins . "-", -1);
		$curso = $ids[0];
		$nivel = $ids[1];
		...
		$list = $this->estudk->get_curso_student($gestion, $curso, $nivel);
		...
		$this->pdf->Output("Inscrip - RUDE ".$nivel." - ".$curso.".pdf", 'I');
