...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		tcolegios=$('#table_mat').DataTable({
			...
			"order":[],
			"ajax":{
				"url":"<?php echo site_url('Estudiantes_link_contr/ajax_list');?>",
				"type":"POST"
			},
			"scrollX":true,
			"columnDefs":[
	...
	function cerrar()
	{		
		var url="<?php echo site_url('Estudiantes_link_contr/ajax_cerrar')?>";
		//alert(url);
	...
	function Get_estu()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Estudiantes_link_contr/Get_estu');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	...
	function materias()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Estudiantes_link_contr/ajax_materias');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
