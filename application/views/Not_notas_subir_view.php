						           ...
						           <!-- <button class="btn bg-brown-300" onclick="generar_estudiantes()"  id="btnindik"><i class="glyphicon glyphicon-check"></i>GENE. ESTUDIANTES</button>-->
						                ...
						                <div class="panel-body">  
        										<div class="col-md-6 col-md-offset-3">                        
                   				 					<div class="col-md-2">
			           				 					<form action="<?=base_url("Not_notas_subir_contr/subir_notas")?>" method="post" enctype="multipart/form-data">
				                 							<input type="file" name="planilla" id="planilla" accept=".xls,.xlsx" />
															<button class="btn btn-primary" onclick="<?=base_url("Not_notas_subir_contr/subir_notas")?>" id="bt2l"><i class="glyphicon glyphicon-cloud-upload"></i>SUBIR</button>
														</form>
													</div>
            									</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
			...
			testudiante=$('#planillas').DataTable({
			"processing":true,
			"serverSide":true,
			"order":[],
			"ajax":{
	...
	function d_planilla($id,$id1)
	{
		...
		// var id=gestion+"W"+cur+"W"+idprof+"W"+materia+"W"+bimestre+"W"+nivel+"W";
 		 ...
 		 var url = "<?php  echo site_url('Not_notas_contr/d_planilla');?>/"+$id;
