				                    	...
				                    	<div class="row">
						                    ...
						                    <div class="col-sm-2">
				                    			<div class="form-group">
						                            ...
						                            <div class="col-md-9">
						                                <input name="Fgestion" placeholder="" class="form-control" type="text" id="Fgestion" value="2020" readonly="true">
						                                <span class="help-block"></span>
						                            </div>
						                        </div>
						                    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		// 	"order":[],
		// 	"ajax":{
		// 		"url":"<?php echo site_url('Reg_inscrip_edit_contr/ajax_list');?>",
		// 		"type":"POST"
		// 	},
	...
	function cerrar()
	{		
		var url="<?php echo site_url('Reg_inscrip_edit_contr/ajax_cerrar')?>";
		//alert(url);
	...
	function get_nivel()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Reg_inscrip_edit_contr/ajax_get_nivel');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	...
	function gescole(level)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Reg_inscrip_edit_contr/ajax_get_level');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	        {   
	           ...
	           {
	           		//datos recuperados
	           		document.getElementById('Fgestion').value=2020;
	...
	function getcur(nivel)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Reg_inscrip_edit_contr/ajax_get_curso');?>",
	        type: "POST",
	        data:datacur,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function cargarBusqueda()
	{
		...
		if(curso=='SEXTO B'){curso='6B';}
		if(curso=='SEXTO C'){curso='6C';}
		idcur=curso+"-"+nivel+"-"+gestion+"-";
		url1="<?php echo site_url('Reg_inscrip_edit_contr/ajax_list_idcurso');?>/"+idcur;    
		testudiante=$('#table_estudiante').DataTable({
			"destroy": true,
			"serverSide":true,
			"order":[],
	...
	function save_estud()
	{
		...
		url="<?php echo site_url('Reg_inscrip_edit_contr/ajax_update_estud');?>";
	...
	function debe(id)
	{
		...
		var url="<?php echo site_url('Reg_inscrip_edit_contr/ajax_get_debe');?>";
...
*/
	...
	//ventana para el pdf
	//ventana para el pdf
	function export_pdf(id_est)
	{
		var gestion=document.getElementById("Fgestion").value;
		var idins=id_est+"-"+gestion+"-";
	    var url = "<?php  echo site_url('inscrip_edit_contr/print_rude');?>/"+idins;
	...
	function export_xls()
	{
	    ...
	    var url = "<?php  echo site_url('Reg_inscrip_edit_contr/printxls');?>/"+valor;
