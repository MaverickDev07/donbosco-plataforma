														...
														<div class="panel ">
															...
															<div class="panel-body">
																<div class="row">
																		...
																		<div class="row">
																			...
																			<div class="col-md-4">
																				<div class="form-group">
																					...
																					<input type="text" name="idcur" id="idcur" class="form-control">
																				</div>
																	...
																	<input type="hidden" name="opcion" id='idestudiante'>
																	<div class="col-lg-12">
																			...
																			<div class="row">
																				<div class="col-md-3">
																					<div class="form-group">
																						...
																						<select id='locdpto' class="form-control required">
																				...
																				<div class="col-md-3">
																					<div class="form-group">
																						...
																						<select id='locprovin' class="form-control required">
																							<option value="OROPEZA">OROPEZA</option>
																						</select>
																					</div>
																				</div>
																				<div class="col-md-3">
																					<div class="form-group">
																						...
																						<select id='locmuni' class="form-control required">
																						...
																						<div class="col-md-12">
																							<div class="form-group">
																								...
																								<select name="actividad" id="actividad" class="select">
																									...
																									<option value="Ganadería o pesca">Ganadería o pesca</option>
																									<option value="Minería">Minería</option>
																									<option value="Construcción">Construcción</option>
																									<option value="Vendedor dependiente">Vendedor dependiente</option>
																									<option value="Vendedor cuenta propia">Vendedor cuenta propia</option>
																									<option value="Transporte o mecánica">Transporte o mecánica</option>
																									<option value="Lustra Botas">Lustra Botas</option>
																									<option value="Trabajo del hogar o niñero">Trabajo del hogar o niñero</option>
																									<option value="Ayudante familiar">Ayudante familiar</option>
																									<option value="Ayudante en el Hogar">Ayudante en el Hogar</option>
																				...
																				<div class="col-md-12">
																					...
																					<div class="col-md-12">
																						...
																						<div class="form-group">
																							...
																							<select name="trabfrecuencia" id="trabfrecuencia" class="select">
																								<option value=""></option>
																				...
																				<div class="col-md-12">
																					...
																					<div class="col-md-4">
																						<div class="form-group">
																							...
																							<input type="text" name="otrollega" id="otrollega" class="form-control" placeholder="helicoptero">
																						</div>
																					</div>
...
<script type="text/javascript">
	...
	function llenar() {
		if (is_numeric(document.getElementById('idest').value)) {
			document.getElementById("idcurnew").value = "";
			document.getElementById("locdpto").value = "";
			document.getElementById("locprovin").value = "";
			document.getElementById("locmuni").value = "";
			document.getElementById("loclocal").value = "";
			document.getElementById("loczona").value = "";
			document.getElementById("loccalle").value = "";
			document.getElementById("locnum").value = "";
			document.getElementById("locfono").value = "";
			document.getElementById("loccel").value = "";
			document.getElementById("idiomanatal").value = "";
			document.getElementById("idioma1").value = "";
			document.getElementById("idioma2").value = "";
			document.getElementById("idioma3").value = "";
			document.getElementById("nacion").value = "";
			document.getElementById("t3appat").value = "";
			document.getElementById("t3apmat").value = "";
			document.getElementById("t3nombres").value = "";
			document.getElementById("t3ci").value = "";
			document.getElementById("t3comple").value = "";
			document.getElementById("t3exten").value = "";
			document.getElementById("t3idioma").value = "";
			document.getElementById("t3ocup").value = "";
			document.getElementById("t3grado").value = "";
			document.getElementById("t3celular").value = "";
			document.getElementById("t3ofifono").value = "";
			document.getElementById("t3fnacdia").value = "";
			document.getElementById("t3fnacmes").value = "";
			document.getElementById("t3fnacanio").value = "";
			document.getElementById("t3parentesco").value = "";
			document.getElementById("t2appat").value = "";
			document.getElementById("t2apmat").value = "";
			document.getElementById("t2nombres").value = "";
			document.getElementById("t2ci").value = "";
			document.getElementById("t2comple").value = "";
			document.getElementById("t2exten").value = "";
			document.getElementById("t2idioma").value = "";
			document.getElementById("t2ocup").value = "";
			document.getElementById("t2grado").value = "";
			document.getElementById("t2celular").value = "";
			document.getElementById("t2ofifono").value = "";
			document.getElementById("t2fnacdia").value = "";
			document.getElementById("t2fnacmes").value = "";
			document.getElementById("t2fnacanio").value = "";
			document.getElementById("t1appat").value = "";
			document.getElementById("t1apmat").value = "";
			document.getElementById("t1nombres").value = "";
			document.getElementById("t1ci").value = "";
			document.getElementById("t1comple").value = "";
			document.getElementById("t1exten").value = "";
			document.getElementById("t1idioma").value = "";
			document.getElementById("t1ocup").value = "";
			document.getElementById("t1grado").value = "";
			document.getElementById("t1celular").value = "";
			document.getElementById("t1ofifono").value = "";
			document.getElementById("t1fnacdia").value = "";
			document.getElementById("t1fnacmes").value = "";
			document.getElementById("t1fnacanio").value = "";
			document.getElementById("oficialia").value = "";
			...
			document.getElementById("nacdia").value = "";
			document.getElementById("nacmes").value = "";
			document.getElementById("nacanio").value = "";;
			document.getElementById("regdiscap").value = "";
			document.getElementById("tdiscap").value = "";
			document.getElementById("gradodiscap").value = "";
			document.getElementById("antunidadedu").value = "";
			document.getElementById("antsie").value = "";
		}
	...
	function getusuario() {
		var url = "<?php echo site_url('Inscrip_est_contr/ajax_usuario') ?>";
		//alert(url);
		$.ajax({
			url: url,
			type: "POST",
	...
	function getnumctto() {
		var url = "<?php echo site_url('Inscrip_est_contr/ajax_get_numctto') ?>";
		//alert(url);
		$.ajax({
			url: url,
			type: "POST",
	...
	function UnidadEdu() {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_unidedu'); ?>";
		...
		$.ajax({
			...
			success: function(data) //cargado de datos del registro 
			{
				if (data.status) {
					...
					document.getElementById("idestudiante").value = data.data[10];
					//getUnidad();
					//alert(data.data[0]);
	...
	function AntUnidadEdu() {
		...
		var colegio = document.getElementById('unidedu').value;

		var dataest = {
			"colegio": colegio
		}

		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_antunidedu'); ?>";
		...
		$.ajax({
			...
			success: function(data) //cargado de datos del registro 
			{
				console.log('Anterior unidad educativa: ', data)
				if (data.status) {
					...
					//document.getElementById("idcur").value = data.data[2];
					//getUnidad();
					//alert(data.data[0]);
			...
			error: function(jqXHR, textStatus, errorThrown) {
				// alert('No puede obtener codigo nuevo, para el registro');
				console.log('ERROR: Anterior unidad educativa: ')
			}
		});
	...
	function getdiscapacida() {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_discapacida'); ?>";
	...
	function getnacimiento() {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_nacimiento'); ?>";
		...
		$.ajax({
			...
			success: function(data) //cargado de datos del registro 
			{
				console.log("obtener nacimiento", data)
				if (data.status) {
					// cargarBusqueda(data.data[0]);
					// _global_idcur=data.data[0];
			...
			error: function(jqXHR, textStatus, errorThrown) {
				// alert('No puede obtener codigo nuevo, para el registro');
				console.log("ERROR: obtener nacimiento")
			}
		});
	...
	function getpadre() {
		...
		$.ajax({
			...
			success: function(data) //cargado de datos del registro 
			{
				console.log("Obtener getpadre: ", data)
				if (data.status) {
					// cargarBusqueda(data.data[0]);
					// _global_idcur=data.data[0];
					document.getElementById("t1appat").value = data.data[0];
			...
			error: function(jqXHR, textStatus, errorThrown) {
				console.log("ERROR: getpadre", jqXHR, textStatus, errorThrown)
				// alert('No puede obtener codigo nuevo, para el registro');
			}
		});
	...
	function getmadre() {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_madre'); ?>";
	...
	function gettutor() {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_tutor'); ?>";
	...
	function getcur(nivel) {
		...
		$.ajax({
			...
			url: "<?php echo site_url('inscrip_est_contr/ajax_get_curso1'); ?>",
			type: "POST",
			data: datacur,
			dataType: "JSON",
			success: function(data) //cargado de datos del registro 
			{
				if (data.status) {
					...
					data.data.forEach(function(item) {
						...
						if (item != 'PREINSCRIPTOS A' && item != 'PREINSCRIPTOS B' && item != 'SEXTO C') {
							options = options + "<option value='" + id + "'>" + item + "</option>";
						}

					});
					options = options + "<option value='6C'>SEXTO C</option>";
	...
	function gescole(level) {
		...
		$.ajax({
			...
			url: "<?php echo site_url('inscrip_est_contr/ajax_get_level'); ?>",
			type: "POST",
			data: data1,
			dataType: "JSON",
			success: function(data) //cargado de datos del registro 
	...
	function getidioma() {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_idioma'); ?>";
	...
	function getdireccion() {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_direccion'); ?>";
	...
	function getUnidad() {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_unid'); ?>";
	...
	function getUnidadAll() {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_unidAll'); ?>";
		...
		$.ajax({
			...
			success: function(data) //cargado de datos del registro 
			{
				if (data.status) {
					...
					document.getElementById("unidedu").innerHTML = options;
					if (!isNaN(document.getElementById('idest').value)) {
						document.getElementById("locdpto").value = "";
						document.getElementById("locprovin").value = "";
						document.getElementById("locmuni").value = "";
						document.getElementById("loclocal").value = "";
	...
	function selectUnid(cole) {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_cole'); ?>";
		if (cole != '') {
			$.ajax({
	...
	function selcole(col) {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_niveles'); ?>";
		if (col != '') {
			$.ajax({
	...
	function selnivel(level) {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_curso'); ?>";
		if (level != '') {
			$.ajax({
	...
	function get_nivel() {
		...
		$.ajax({
			...
			url: "<?php echo site_url('inscrip_est_contr/ajax_get_nivel1'); ?>",
			type: "POST",
			data: data1,
			dataType: "JSON",
			success: function(data) //cargado de datos del registro 
	...
	function getidcur() {
		...
		var url = "<?php echo site_url('inscrip_est_contr/ajax_get_idcur'); ?>";
	...
	function getidestnew() {
		...
		$.ajax({
			...
			url: "<?php echo site_url('inscrip_est_contr/ajax_get_idestnew'); ?>",
			type: "POST",
			data: data1,
			dataType: "JSON",
			success: function(data) //cargado de datos del registro 
	...
	function guardarIns() {
		// Validar: unidedu, nivel(niveles), curso
		...
		if (document.getElementById("discap1").checked) {
			discap1 = document.getElementById("discap1").value;
		} else {
			discap1 = document.getElementById("discap2").value;
		}
		/*for (i = 0; i < discap.length; i++) {
			if (discap[i].checked) {
				var discap1 = discap[i].value;
		...
		var t1lug = document.getElementById("t1lug").value;
		...
		var t2lug = document.getElementById("t2lug").value;
		...
		var t3lug = document.getElementById("t3lug").value;
		...
		// VALIDAR
		if (!unidedu || !niveles || !curso) {
			alert('Debe llenar: Nombre de la Unidad Educativa, Nivel y Curso de la gestión actual del estudiante.');
			return;
		}
		...
		// alert("-"+niveles);
		// alert("100000");	
		url = "<?php echo site_url('inscrip_est_contr/ajax_save_estud'); ?>";
		...
		*/
		$.ajax({
			...
			error: function(jqXHR, textStatus, errorThrown) {
				console.error('ERROR Inscrip:', jqXHR, textStatus, errorThrown);
	...
	function export_pdf() {
		...
		// var url = "<?php // echo site_url('inscrip_est_contr/print_rude'); 
									?>/" + idins;
