					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									<a href='<?php echo site_url('Rep_centralizador_contr');?>'><i class="icon-user-lock"></i> <span>Centralizador</span></a>									
								</li>
								<li>
									<a href='<?php echo site_url('Rep_estadisticas_contr');?>'><i class="icon-user-lock"></i> <span>Estadísticas</span></a>									
								</li>
								<li>
							...
							<div class="panel ">
								...
								<div class="panel-body">
				                    	<div class="row">
						                    ...
						                    <div class="col-sm-4">
				                    			<div class="form-group">
						                            <label class="control-label col-md-12">UNID. EDU:</label>
						                            <div class="col-md-12">
						                    ...
						                    <div class="col-sm-3">
				                    			<div class="form-group">
						                            <label class="control-label col-md-12">GRADO:</label>
						                            <div class="col-md-12">
						                    ...
						                    <div class="col-sm-3">
				                    			<div class="form-group">
						                            <label class="control-label col-md-12">BIMESTRE:</label>
						                            <div class="col-md-12">
						                                <select  name="Fbimestre" class="form-control" id="Fbimestre">
						                                	<option></option>
						                                	<option value='5'>PRIMER TRIMESTRE</option>
						                                	<option value='6'>SEGUNDO TRIMESTRE</option>
						                                	<option value='7'>TERCER TRIMESTRE</option>
						                                </select>
						                                <span class="help-block"></span>
						                            </div>
						                        </div>
						                    ...
						                    <div class="col-sm-3">
				                    			<div class="col-md-12">
				                    				...
				                    				<div class="bs-example" data-example-id="button-group-nesting"> 
				                    					<div class="btn-group" role="group" aria-label="Button group with nested dropdown"> 
				                    					<div class="btn-group" role="group"> 
		                    							<button type="button" class="btn btn-success">CLASES COMPLENTARIAS</button>
		                    							<button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="caret"></span> <span class="sr-only">Toggle Dropdown</span> </button>

		                    						<ul class="dropdown-menu bg-success-300 btn-float btn-float-lg" id="menu1" aria-labelledby="drop4"> 
		                    				  			<li><a  onclick="centralizador_compl()">CENTRALIZADOR<i class="icon icon-file-excel"></i></a></li> 
		                    				  		</ul> 
		                    						</div>
						                    ...
						                    <div class="col-sm-3">
						                    	<button class="btn  btn-danger" onclick="get2019()" ><i class="icon icon-file-pdf"></i>  &nbsp;&nbsp;&nbsp;&nbsp;2019&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
						                    </div>
						                    
						                    <!--<div class="col-sm-3">
						                    	<button class="btn  btn-danger" onclick="migra()" ><i class="icon icon-file-pdf"></i>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
						                    </div>
						                    </div>-->
						                </div>
...
<script type="text/javascript">
	...
	function get2019()
	{		
		var enlace="<?php echo site_url('Rep_centralizador_2019_contr')?>";
	...
	{		
		...
		var url="<?php echo site_url('Rep_centralizador_contr/ajax_get_idcurso');?>";
	...
	function cargarBusqueda(notlimit,idcur,bimes,gestion,nivel,curso)
	{
		...
		url="<?php  echo site_url('Rep_centralizador_contr/ajax_load_sql');?>";
...
*/
	...
	function export_pdf()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/printcentr');?>/"+valor;
	...
	function estadisticas()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/estadisticas_apro');?>/"+valor;
	...
	function export1_excel()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/excel_centralizador');?>/"+valor;
	...
	function export_excel()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/excel_curso');?>/"+valor;
	...
	function centralizador_compl()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/centralizador_compl');?>/"+valor;
	...
	function migra()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/migra');?>/"+valor;
	...
	function boletin()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/boletines');?>/"+valor;
	...
	function bonojp()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/bonojp');?>/"+valor;
	...
	function kardexs()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/kardexs');?>/"+valor;
	...
	function acumulador_rep()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/acumulador_rep');?>/"+valor;
	...
	function acumulador_rep1()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/acumulador_rep1');?>/"+valor;
...
function acumulador()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/acumulador');?>/"+valor;
	...
	function acumulador6to()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/acumulador6to');?>/"+valor;
...
function reprobados()
	...
	function acumulados_pdf()
	{
	    ...
	    var url = "<?php echo site_url('Rep_centralizador_contr/printacumulado');?>/"+valor;
	...
	function printBoletin()
	{
	    ...
	    var url = "<?php  echo site_url('Rep_centralizador_contr/printboletin');?>/"+valor;
	...
	function printPinto()
	{
	    ...
	    var url = "<?php  echo site_url('Rep_centralizador_contr/printjuancito');?>/"+valor;
