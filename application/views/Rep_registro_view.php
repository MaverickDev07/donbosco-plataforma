							...
							<div class="panel ">
								...
								<div class="panel-body">
				                    	...
				                    	<div class="row">
						                    ...
						                    <div class="col-sm-3">
				                    			<!-- <div class="form-group">				                    								                    				
				                    				<button class="btn bg-brown-300" onclick="avance()" id="btnAvance"><i class="glyphicon glyphicon-arrow-right"></i> &nbsp;AVANCE &nbsp;&nbsp;</button>					                            
						                        </div> -->
						                    </div>
						                </div>
						                <div class="row">
						                    ...
						                    <div class="col-sm-3">
				                    			<div class="form-group">
						                            ...
						                            <div class="col-md-9">
						                                <select  name="Fbimestre" class="form-control" id="Fbimestre" onchange="fill_table_nota(this.value);">
						                                	<option value=''></option>
						                    ...
						                    <div class="col-sm-3">
				                    			<div class="form-group">				                    								                    				                    				
						                            <button class="btn bg-brown-300" onclick="modal_indica()"  id="btnindik"><i class="glyphicon glyphicon-check"></i> INDICADORES</button>						                            
						                        </div>
						                    </div>
