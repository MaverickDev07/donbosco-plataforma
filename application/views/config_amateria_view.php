								...
								<div class="panel-body">
									<div class="col-sm-3">
		                    			<div class="form-group">
											<button class="btn bg-primary-600" onclick="add_mat()"><i class="glyphicon glyphicon-plus"></i> Add Materia</button>
					                ...
					                <div class="col-sm-2">
					                	<div class="form-group">
		                    				<label class="control-label">NIVEL:</label>
				                                <Select class="form-control" type="text" id="Fnivel" onchange="getcole(this.value);getcurso(this.value);gescole(this.value);getcur(this.value)">
				                                </Select>
					                ...
					                <div class="col-sm-2">
					                	<div class="form-group">
				                            <label class="control-label">CURSO:</label>
				                                <select  name="Fcurso" class="form-control" id="Fcurso" onchange="ListaMateria()">
				                                </select>
				                                <span class="help-block"></span>
				                        </div>
					                </div>
...
<script type="text/javascript">
	...
	function get_meteria()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('config_amateria_contr/ajax_get_materia');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	{		
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('config_amateria_contr/ajax_get_area');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function cerrar()
	{		
		var url="<?php echo site_url('config_amateria_contr/ajax_cerrar')?>";
		//alert(url);
	...
	function get_gestion()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Config_amateria_contr/ajax_get_gestion');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function add_mat() //CARGA EL MODAL
	{
	   ...
	   // document.getElementById('loadimg').src=temp;
	    ...
	    $('.modal-title').text('ADICIONAR MATERIAS'); // Set Title to Bootstrap modal title
	...
	function get_idcod()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Config_amateria_contr/ajax_get_id');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getnivel()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Config_amateria_contr/ajax_get_level');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcurso(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Config_amateria_contr/ajax_curso_nivel');?>",
	        type: "POST",
	        data:datacur,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcurso2(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Config_amateria_contr/ajax_get_curso2');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcorto(cur)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Config_amateria_contr/ajax_get_corto');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getprofe()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Config_amateria_contr/ajax_get_profe');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getprofe2(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Config_amateria_contr/ajax_get_profe2');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getidprof(nomb)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Config_amateria_contr/ajax_get_idprofe');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function save_materia()
	{
		...
		if(save_method=='add')
		{
			url="<?php echo site_url('config_amateria_contr/ajax_set_materia');?>";
		}
		else{
			url="<?php echo site_url('config_amateria_contr/ajax_update_materia');?>";
		}
	...
	function delete_materia(id)
	{
        ...
        function(isConfirm){
            if (isConfirm) {
            	$.ajax({
		            url : "<?php echo site_url('Config_amateria_contr/ajax_delete')?>/"+id,
		            type: "POST",
		            dataType: "JSON",
		            success: function(data)
		            {
	...
	function edit_materia(id)
	{
		...
		$.ajax({
			url:"<?php echo site_url('Config_amateria_contr/ajax_edit_materia'); ?>/"+id,
			type:"GET",
			dataType:"JSON",
			success: function(data)
			{
				...
				$('[name="id"]').val(data.id_asg_mate);
				$('[name="nivel"]').val(codigos[1]);
				getcole(codigos[1]);			
				$('[name="materia"]').val(data.id_mat);
				get_area(data.id_mat);			
				$('[name="curso"]').val(data.id_asg_cur);								
	...
	function selGestion(id)
	{
		url1="<?php echo site_url('Config_amateria_contr/ajax_list_materia');?>/"+id;    
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
		                ...
		                <div class="row">		                	
                    		...
                    		<div class="col-md-5">
								<div class="form-group">
		                            <label class="control-label col-md-2">COLEGIO</label>
		                            <div class="col-md-10">
		                ...
		                <div class="row">
                    		<div class="col-md-7">
                    			<div class="form-group">
		                            ...
		                            <div class="col-md-10">
		                            	<Select class="form-control" name="materia" id="materia" onchange="get_area(this.value)">
		                                </Select>
		                                <span class="help-block"></span>
		                            </div>
		                        </div>                 			
            ...
            <div class="modal-footer bg-primary-300">
            	<br>
                <button type="button" id="btnSave" onclick="save_materia()" class="btn bg-grey-600">Save</button>
