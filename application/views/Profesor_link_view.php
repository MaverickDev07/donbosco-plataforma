						...
						<div class="col-lg-12">
							<div class="panel ">
								<div class="panel-heading bg-primary-300">
									<h6 class="panel-title">Clases Virtuales</h6>
					                ...
					                <div class="col-sm-5">
					                	<div class="form-group">
		                    				<label class="control-label">NIVEL:</label>
				                                <Select class="form-control" type="text" name="Fnivel"  id="Fnivel" onchange="gescole(this.value);get_temas()">
				                                </Select>
				                                <span class="help-block"></span>				                           
			                            </div>
					                </div>
...
<script type="text/javascript">
	...
	function editnota()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/editnota');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	...
	function calnota()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/calnota');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function editar(tarea,id_tema)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/editar');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function calificar(tarea,id_tema)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/calificar');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function export_lista()
	{
	    ...
	    var url = "<?php  echo site_url('Profesor_link_contr/export_exel');?>/"+id;
	    //alert(url);
	...
	function generar()
	{
	    ...
	    var url = "<?php  echo site_url('Profesor_link_contr/generar');?>/"+id;
	...
	{	
		...
		var data1={
			...
			$.ajax({
		        ...
		        url : "<?php echo site_url('Profesor_link_contr/temas');?>",
		        type: "POST",
		        data:data1,
		        dataType: "JSON",
		        success: function(data)//cargado de datos del registro 
	...
	function cerrar()
	{		
		var url="<?php echo site_url('Profesor_link_contr/ajax_cerrar')?>";
		//alert(url);
	...
	function get_gestion()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/ajax_get_gestion');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function get_idcod()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/ajax_get_id');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getnivel()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/ajax_get_level');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcurso(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/ajax_get_curso');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function materias()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/ajax_materias');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcurso2(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/ajax_get_curso2');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcorto(cur)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/ajax_get_corto');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getprofe()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/ajax_get_profe');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getprofe2(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/ajax_get_profe2');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getidprof(nomb)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/ajax_get_idprofe');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function save_profesor()
	{
		...
		if(save_method=='add')
		{
			url="<?php echo site_url('Profesor_link_contr/ajax_set_profesor');?>";
		}
		else{
			url="<?php echo site_url('Profesor_link_contr/ajax_update_profeso');?>";
		}
	...
	function delete_temas(id)
	{
        ...
        function(isConfirm){
            if (isConfirm) {
            	$.ajax({
		            url : "<?php echo site_url('Profesor_link_contr/ajax_delete_temas')?>/"+id,
		            type: "POST",
		            dataType: "JSON",
		            success: function(data)
		            {
	...
	function delete_tareas(id)
	{
        ...
        function(isConfirm){
            if (isConfirm) {
            	$.ajax({
		            url : "<?php echo site_url('Profesor_link_contr/ajax_delete_tareas')?>/"+id,
		            type: "POST",
		            dataType: "JSON",
		            success: function(data)
		            {
	...
	function edit_profesor(id)
	{
		...
		$.ajax({
			url:"<?php echo site_url('Profesor_link_contr/ajax_edit_profesor'); ?>/"+id,
			type:"GET",
			dataType:"JSON",
			success: function(data)
			{
	...
	{		
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_link_contr/ajax_get_area');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function get_temas()
	{
		...
		var id=gestion+"-"+nivel+"-"+id_prof;
		
		url1="<?php echo site_url('Profesor_link_contr/ajax_list_temas');?>/"+id;    
	...
	function getestud()
	{
		...
		getcole(nivel);
				...
				// alert(codigos[4]);
		// alert("");
		url1="<?php echo site_url('Profesor_link_contr/ajax_list_profesor');?>/"+id;    
		tmateria=$('#table_mat').DataTable({
			"destroy": true,
			"serverSide":true,
			"order":[],
