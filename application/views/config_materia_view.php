					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									<a href='<?php echo site_url('Config_materia_contr');?>'><i class="icon-user-minus"></i> <span>Cursos</span></a>									
								</li>
						...
						<div class="col-lg-12">
							<div class="panel ">
								<div class="panel-heading bg-primary-300">
									<h6 class="panel-title">Gestionar Materia</h6>
								...
								<div class="panel-body">
									<button class="btn btn-primary" onclick="add_materia()"><i class="glyphicon glyphicon-plus"></i> Nuevo Materia</button>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		tcurso=$('#table_curso').DataTable({
			...
			"order":[],
			"ajax":{
				"url":"<?php echo site_url('Config_materia_contr/ajax_list');?>",
				"type":"POST"
			},
			"scrollX":true,
			"columnDefs":[
	...
	function cerrar()
	{
		...
		var url="<?php echo site_url('config_materia_contr/ajax_cerrar')?>";
		//alert(url);
	...
	function add_materia()
	{
	    ...
	    $('.modal-title').text('ADICIONAR MATERIA'); // Set Title to Bootstrap modal title
	...
	function get_idcod()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Config_materia_contr/ajax_get_id');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	...
	function get_area()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Config_materia_contr/ajax_get_area');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcurso()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Config_materia_contr/ajax_get_cursos');?>",
	        type: "POST",
	        data:datacur,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	//	alert("hijito");
		...
		var id,materia,area,sigla;
		var error=false;
		var url;
				
		if(save_method=='add')
		{
			url="<?php echo site_url('Config_materia_contr/ajax_set_materia');?>";
		}
		else{
			url="<?php echo site_url('Config_materia_contr/ajax_update_materia');?>";
		}
	...
	function delete_curso(id)
	{
        ...
        function(isConfirm){
            if (isConfirm) {
            	$.ajax({
		            url : "<?php echo site_url('Config_materia_contr/ajax_delete')?>/"+id,
		            type: "POST",
		            dataType: "JSON",
		            success: function(data)
		            {
	...
	function edit_materia(id)
	{
		...
		$.ajax({
			url:"<?php  echo site_url('Config_materia_contr/ajax_edit_materia'); ?>/"+id,
			type:"GET",
			dataType:"JSON",
			success: function(data)
			{
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="materia" placeholder="MATERIA" class="form-control" type="text" id="materia">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="sigla" placeholder="SIGLA" class="form-control" type="text" id="sigla">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-footer bg-primary-300">
            	<br>
                <button type="button" id="btnSave" onclick="save_materia()" class="btn bg-info-700">Guardar</button>
