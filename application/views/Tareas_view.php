					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									<a href='<?php echo site_url('Tareas_contr');?>'><i class="icon-user-lock"></i> <span>Tareas</span></a>									
								</li>
						...
						<div class="col-lg-12">
							<div class="panel ">
								<div class="panel-heading bg-primary-300">
									<h6 class="panel-title">Descargar Tarea</h6>
					                ...
					                <div class="col-sm-3">
					                	<div class="form-group">
				                            <label class="control-label">CURSO:</label>
				                                <select  name="Fcurso" class="form-control" id="Fcurso" onchange="materias();">
				                                </select>
				                                <span class="help-block"></span>
				                        </div>
					                </div>
							<div class="col-sm-6">
					                	<div class="form-group">
				                            <label class="control-label">MATERIA:</label>
				                                <select  name="materia" class="form-control" id="materia" onchange="profesor();">
				                                </select>
				                                <span class="help-block"></span>
				                        </div>
					                </div>
							<div class="col-sm-6">
					                	<div class="form-group">
				                            <label class="control-label">PROFESOR:</label>
				                                <select  name="profesor" class="form-control" id="profesor" onchange="getestud();">
				                                </select>
				                                <span class="help-block"></span>
				                        </div>
					                </div>
...
<script type="text/javascript">
	...
	function get_nivel()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_niveles');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	...
	{		
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_colegio');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcur(nivel)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_cursos');?>",
	        type: "POST",
	        data:datacur,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function cerrar()
	{		
		var url="<?php echo site_url('Tareas_contr/ajax_cerrar')?>";
		//alert(url);
	...
	function get_gestion()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_gestion');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function get_idcod()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_id');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getnivel()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_level');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcurso(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_curso');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function materias()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_materias');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function profesor()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_profesor');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	        {   var i=-1;
	           if(data.status)
	           {
	           		...
	           		document.getElementById('profesor').innerHTML=options;            	
	           }
	        },
	        error: function (jqXHR, textStatus, errorThrown)
	        {
	...
	function getmateria(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_materia');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcurso2(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_curso2');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcorto(cur)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_corto');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getprofe()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_profe');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getprofe2(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_profe2');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getidprof(nomb)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_idprofe');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function save_profesor()
	{
		...
		if(save_method=='add')
		{
			url="<?php echo site_url('Tareas_contr/ajax_set_profesor');?>";
		}
		else{
			url="<?php echo site_url('Tareas_contr/ajax_update_profeso');?>";
		}
	...
	function delete_materia(id)
	{
        ...
        function(isConfirm){
            if (isConfirm) {
            	$.ajax({
		            url : "<?php echo site_url('Tareas_contr/ajax_delete')?>/"+id,
		            type: "POST",
		            dataType: "JSON",
		            success: function(data)
		            {
	...
	function descarga_tarea(id)
	{
		...
		$.ajax({
			url:"<?php echo site_url('Tareas_contr/ajax_edit_profesor'); ?>/"+id,
			type:"GET",
			dataType:"JSON",
			success: function(data)
			{
	...
	{		
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Tareas_contr/ajax_get_area');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getestud()
	{
		...
		var id=	gestion+"-"+nivel+"-"+curso+"-"+profesor+"-"+materia;
		getcurso(nivel);	
		getcole(nivel);
		
				// alert(codigos[4]);
		// alert("");
		url1="<?php echo site_url('Tareas_contr/ajax_list_profesor');?>/"+id;    
