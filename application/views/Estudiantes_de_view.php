					                ...
					                <div class="col-sm-3">
					                	<div class="form-group">
				                            <label class="control-label">CATEGORIA:</label>
				                              <select  name="categoria" class="form-control" id="categoria" onchange="get_temas()">
								<option value=''></option>
...
<script type="text/javascript">
	...
	function generar()
	{
	    ...
	    var url = "<?php  echo site_url('Estudiantes_de_contr/generar');?>/"+id;
	...
	{	
		...
		var data1={
			...
			$.ajax({
		        ...
		        url : "<?php echo site_url('Estudiantes_de_contr/temas');?>",
		        type: "POST",
		        data:data1,
		        dataType: "JSON",
	...
	function cerrar()
	{		
		var url="<?php echo site_url('Estudiantes_de_contr/ajax_cerrar')?>";
		//alert(url);
	...
	function get_idcod()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Estudiantes_de_contr/ajax_get_id');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function Get_estu()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Estudiantes_de_contr/Get_estu');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcurso(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Estudiantes_de_contr/ajax_get_curso');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function gestemas(id_prof)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Estudiantes_de_contr/ajax_temas');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function gesprof(id_mat)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Estudiantes_de_contr/ajax_profesor');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function materias()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Estudiantes_de_contr/ajax_materias');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function get_temas()
	{
		...
		var id=materia+"-"+categoria+"-"+id_prof;
		
		url1="<?php echo site_url('Estudiantes_de_contr/ajax_list_temas');?>/"+id;    
