						...
						<div class="col-lg-12">
							<div class="panel ">
								<div class="panel-heading bg-primary-300">
									<h6 class="panel-title">Calendario Virtual</h6>
...
<form action="<?=base_url("Profesor_ca_contr/subir")?>" method="post" enctype="multipart/form-data">
									<div class="col-lg-12">
										<div class="col-sm-6">
					                ...
					                <div class="col-sm-4">
					                	<div class="form-group">
				                            <label class="control-label">MATERIA:</label>
				                                <select  name="materia" class="form-control" id="materia" onchange="get_calendario()">
				                                </select>
				                                <span class="help-block"></span>
				                        	</div>
							</div>
							<div class="col-sm-2">
			                	<div class="form-group">
		                            <label class="control-label">MES:</label>
		                                <select  name="mes" class="form-control" id="mes" required="required">
							<option value=''></option>
							...
							<option value='12'>DICIEMBRE</option>
   				 					...
   				 					<div class="col-md-2">
											...
											<button class="btn btn-primary" onclick="<?=base_url("Profesor_ca_contr/subir")?>" id="bt2l"><i class="glyphicon glyphicon-cloud-upload"></i>SUBIR</button>
...
<script type="text/javascript">
	...
	function get_calendario()
	{
		...
		var id=gestion+"-"+nivel+"-"+curso+"-"+materia+"-"+id_prof;
		
		url1="<?php echo site_url('Profesor_ca_contr/ajax_list_calendario');?>/"+id;    
	...
	function generar()
	{
	    ...
	    var url = "<?php  echo site_url('Profesor_ca_contr/generar');?>/"+id;
	...
	function cerrar()
	{		
		var url="<?php echo site_url('Profesor_ca_contr/ajax_cerrar')?>";
		//alert(url);
	...
	function get_gestion()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_ca_contr/ajax_get_gestion');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function get_idcod()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_ca_contr/ajax_get_id');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getnivel()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_ca_contr/ajax_get_level');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcurso(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_ca_contr/ajax_get_curso');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function materias()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_ca_contr/ajax_materias');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcurso2(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_ca_contr/ajax_get_curso2');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcorto(cur)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_ca_contr/ajax_get_corto');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getprofe()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_ca_contr/ajax_get_profe');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getprofe2(id)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_ca_contr/ajax_get_profe2');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getidprof(nomb)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_ca_contr/ajax_get_idprofe');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function save_profesor()
	{
		...
		if(save_method=='add')
		{
			url="<?php echo site_url('Profesor_ca_contr/ajax_set_profesor');?>";
		}
		else{
			url="<?php echo site_url('Profesor_ca_contr/ajax_update_profeso');?>";
		}
	...
	function delete_temas(id)
	{
        ...
        function(isConfirm){
            if (isConfirm) {
            	$.ajax({
		            url : "<?php echo site_url('Profesor_ca_contr/ajax_delete_temas')?>/"+id,
		            type: "POST",
		            dataType: "JSON",
		            success: function(data)
		            {
	...
	function delete_tareas(id)
	{
        ...
        function(isConfirm){
            if (isConfirm) {
            	$.ajax({
		            url : "<?php echo site_url('Profesor_ca_contr/ajax_delete_tareas')?>/"+id,
		            type: "POST",
		            dataType: "JSON",
		            success: function(data)
		            {
	...
	function edit_profesor(id)
	{
		...
		$.ajax({
			url:"<?php echo site_url('Profesor_ca_contr/ajax_edit_profesor'); ?>/"+id,
			type:"GET",
			dataType:"JSON",
			success: function(data)
			{
	...
	{		
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Profesor_ca_contr/ajax_get_area');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getestud()
	{
		...
		getcole(nivel);
				...
				// alert(codigos[4]);
		// alert("");
		url1="<?php echo site_url('Profesor_ca_contr/ajax_list_profesor');?>/"+id;    
		tmateria=$('#table_mat').DataTable({
			"destroy": true,
			"serverSide":true,
			"order":[],
