						...
						<div class="col-lg-12">
							<div class="panel ">
								<div class="panel-heading bg-info-400">
									<h6 class="panel-title">Inscripción 123</h6>
...
<script type="text/javascript">
	...
	function AntUnidadEdu()
	{
		...
		var url="<?php echo site_url('inscrip_contr/ajax_get_antunidedu');?>";
	...
	function getdiscapacida()
	{
		...
		var url="<?php echo site_url('inscrip_contr/ajax_get_discapacida');?>";
	...
	function getnacimiento()
	{
		...
		var url="<?php echo site_url('inscrip_contr/ajax_get_nacimiento');?>";
	...
	function getpadre()
	{
		...
		var url="<?php echo site_url('inscrip_contr/ajax_get_padre');?>";
	...
	function getmadre()
	{
		...
		var url="<?php echo site_url('inscrip_contr/ajax_get_madre');?>";
	...
	function gettutor()
	{
		...
		var url="<?php echo site_url('inscrip_contr/ajax_get_tutor');?>";
	...
	function getcur(nivel)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('inscrip_contr/ajax_get_curso1');?>",
	        type: "POST",
	        data:datacur,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	        {   
	           ...
	           { var id='';
	           		...
	           		data.data.forEach(function(item){
	           			...
	           			if(item!='PREINSCRIPTOS A' && item!='PREINSCRIPTOS B'&& item!='QUINTO C' && item!='SEXTO C'){
	...
	function gescole(level)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('inscrip_contr/ajax_get_level');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getidioma()
	{
		...
		var url="<?php echo site_url('inscrip_contr/ajax_get_idioma');?>";
	...
	function getdireccion()
	{
		...
		var url="<?php echo site_url('inscrip_contr/ajax_get_direccion');?>";
	...
	function selcole(col)
	{
		...
		var url="<?php echo site_url('inscrip_contr/ajax_get_niveles');?>";
		if (col!='')
		{
			$.ajax({
	...
	function get_nivel()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('inscrip_contr/ajax_get_nivel1');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
...
*/
	...
	function print_ctto()
	{
		...
		var gestion=document.getElementById("gestion").value;
		// alert(gestion);
	    var url = "<?php  echo site_url('inscrip_contr/print_ctto');?>/"+gestion+"-"+id_est+"-";	
