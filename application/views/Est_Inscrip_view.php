													...
													<div class="panel-body">
														...
														<select id='nacmes' data-placeholder="Mes" class="form-control">
															...
															<option value="Diciembre">Diciembre</option>
																	...
																	<div class="col-md-4">
																		<label>Gestion Inscrito: <span class="text-danger">*</span></label>
																		<div class="form-group">
																			<input type="text" id='gestion_ant' class="form-control" readonly="true" value="2020">
																		</div>
																	</div>
																	...
																	<div class="col-md-12">
																		<div class="form-group">
																			...
																			<label class="radio-inline">
																				<input type="radio" name="rdiscap" id="discap1" value="1" class="styled" checked="checked">
																				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Si
																			</label>

																			<label class="radio-inline">
																				<input type="radio" name="rdiscap" id="discap2" value="0" class="styled">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No
																			</label>
																		</div>
																	</div>
																	<div class="col-md-4">
														...
														<div class="panel-body">
															...
															<div class="col-md-12">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label>Grado: </label>
																		<input type="text" id='t1grado' class="form-control">
																	</div>
																</div>
																<div class="col-md-12">
																	<div class="form-group">
																		<label>Ocupación: </label>
																		<input type="text" id='t1ocup' class="form-control">
														...
														<div class="panel-body">
															...
															<div class="col-md-12">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label>Grado: </label>
																		<input type="text" id='t2grado' class="form-control">
																...
																<div class="col-md-12">
																	<div class="form-group">
																		<label>Ocupación: </label>
																		<input type="text" id='t2ocup' class="form-control">
																	</div>
																	<div class="col-md-12">
																		<div class="form-group">
																			<label>Lugar Trabajo: </label>
														...
														<div class="panel-body">
															...
															<div class="col-md-12">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label>Grado: </label>
																		<input type="text" id='t3grado' class="form-control">
																	</div>
																</div>
																...
																<div class="col-md-12">
																	<div class="form-group">
																		<label>Ocupación: </label>
																		<input type="text" id='t3ocup' class="form-control">
																	</div>
																	<div class="col-md-12">
																		<div class="form-group">
																			<label>Lugar Trabajo: </label>
...
<script type="text/javascript">
	...
	function getcultura() {
		...
		var idest = document.getElementById('idest').value;
		var gestion = document.getElementById('gestion_ant').value;
