				                    				...
				                    				<div class="bs-example" data-example-id="button-group-nesting"> 
					                    						...
					                    						<div class="btn-group" role="group"> 
					                    							...
					                    							<ul class="dropdown-menu bg-info-300 btn-float btn-float-lg" id="menu1" aria-labelledby="drop4"> 
					                    				  			<li><a  onclick="Axcurso()">APROVECHAMIENTO <i class="icon icon-file-excel"></i></a></li> 
					                    				  			<li role="separator" class="divider"></li> 
...
<script type="text/javascript">
	...
	function Mxcurso()
	{
	    ...
	    var url = "<?php echo site_url('Rep_estadisticas_contr/Mxcurso');?>/"+valor;
	...
	function Cxcurso()
	{
	    ...
	    var url = "<?php echo site_url('Rep_estadisticas_contr/Cxcurso');?>/"+valor;
	...
	function Axcurso()
	{
	    ...
	    var url = "<?php echo site_url('Rep_estadisticas_contr/Axcurso');?>/"+valor;
	...
	function familia()
	{
	    ...
	    var url = "<?php echo site_url('Rep_estadisticas_contr/familia');?>/"+valor;
	...
	function estadistica_a()
	{
	    ...
	    var url = "<?php echo site_url('Rep_estadisticas_contr/estadistica_a');?>/"+valor;
	...
	function Bxcurso()
	{
	    ...
	    var url = "<?php echo site_url('Rep_estadisticas_contr/Bxcurso');?>/"+valor;
	...
	function Bxcolegio()
	{
	    ...
	    var url = "<?php echo site_url('Rep_estadisticas_contr/Bxcolegio');?>/"+valor;
	...
	function Mxcolegio()
	{
	    ...
	    var url = "<?php echo site_url('Rep_estadisticas_contr/Mxcolegio');?>/"+valor;
	...
	function Cxcolegio()
	{
	    ...
	    var url = "<?php echo site_url('Rep_estadisticas_contr/Cxcolegio');?>/"+valor;
	...
	function get_nivel()
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Rep_estadisticas_contr/ajax_get_nivel');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	...
	function gescole(level)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Rep_estadisticas_contr/ajax_get_level');?>",
	        type: "POST",
	        data:data1,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	function getcur(nivel)
	{
		...
		$.ajax({
	        ...
	        url : "<?php echo site_url('Rep_estadisticas_contr/ajax_get_curso');?>",
	        type: "POST",
	        data:datacur,
	        dataType: "JSON",
	        success: function(data)//cargado de datos del registro 
	...
	{	
		...
		if(document.getElementById('t1').checked)
		{
			...
			url="<?php echo site_url('Rep_estadisticas_contr/ajax_list_promovidos');?>";
	...
	function export_pdf()
	{
	    ...
	    var url = "<?php  //echo site_url('Rep_estadisticas_contr/print');?>/"+valor;
	...
	*/
	...
	function export_xls()
	{
	    ...
	    var url = "<?php  //echo site_url('Rep_estadisticas_contr/printxls');?>/"+valor;
